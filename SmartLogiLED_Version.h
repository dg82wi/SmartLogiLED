...
#define SMARTLOGILED_VERSION_MINOR      0
#define SMARTLOGILED_VERSION_PATCH      0
#define SMARTLOGILED_VERSION_BUILD      0

// String representations
#define SMARTLOGILED_VERSION_STRING     L"3.0.0"
#define SMARTLOGILED_VERSION_STRING_A   "3.0.0"
#define SMARTLOGILED_VERSION_FULL       L"3.0.0.0"
#define SMARTLOGILED_VERSION_FULL_A     "3.0.0.0"
